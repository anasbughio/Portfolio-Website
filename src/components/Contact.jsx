            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-center gap-4 bg-[#111622] border border-slate-800/90 p-4 rounded-xl max-w-sm">
                ...
                <div>
                  ...
                  <a 
                    href="mailto:hello@devportfolio.tech" 
                    className="text-xs sm:text-sm font-bold text-slate-200 hover:text-[#7B88FF] transition-colors"
                  >
              ...
              <div className="flex items-center gap-4 bg-[#111622] border border-slate-800/90 p-4 rounded-xl max-w-sm">
                ...
                <div>
                  ...
                  <div className="text-xs sm:text-sm font-bold text-slate-200 flex items-center gap-2 mt-0.5">
                    <a href="https://github.com/anasbughio" target="_blank" rel="noreferrer" className="hover:text-[#7B88FF] transition-colors">
                      GitHub
                    </a>
                    <span className="text-slate-600 font-normal">/</span>
                    <a href="https://linkedin.com/in/anasbughio" target="_blank" rel="noreferrer" className="hover:text-[#7B88FF] transition-colors">
                      LinkedIn
                    </a>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 bg-[#111622] border border-slate-800 rounded-2xl p-7 sm:p-10 shadow-2xl">
            <form className="space-y-6">
              ...
              <div className="pt-2 flex justify-end">
                <button 
                  type="submit" 
                  className="inline-flex items-center gap-2 bg-[#B4BCFF] hover:bg-[#7B88FF] text-[#0B0F17] font-bold text-sm px-7 py-3.5 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer"
                >
